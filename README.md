...
docker exec -i ac-database mysql -uroot -ppassword acore_characters < \
  modules/mod-llm-chatter/data/sql/characters/updates/20260902_group_vibe_source_type.sql
...
mysql -uroot -ppassword acore_characters < \
  data/sql/characters/updates/20260902_group_vibe_source_type.sql
```
