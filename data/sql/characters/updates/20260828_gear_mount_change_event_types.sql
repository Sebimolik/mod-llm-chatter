-- Add the memory-maintenance, gear-change and mount-change
-- event types (the background memory_clean pass, and bots
-- noticing the player's newly-equipped item or
-- newly-summoned mount). Idempotent: guarded by a
...
SET @has_gear_change = (
  ...
  WHERE TABLE_SCHEMA = DATABASE()
    ...
    AND COLUMN_TYPE LIKE '%bot_group_gear_change%'
);
